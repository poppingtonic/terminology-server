...
RUN apt-get install postgresql postgresql-contrib postgresql-plpython-9.3 openjdk-7-jdk redis-server elasticsearch python-virtualenv virtualenvwrapper python-pip -yqq
