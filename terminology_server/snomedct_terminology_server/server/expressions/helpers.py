"""Utilities / helpers"""
# -coding=utf-8
from antlr4.error.ErrorListener import ErrorListener  # noqa
...
class VerboseErrorListener(ErrorListener):
    def syntaxError(self, recognizer, offendingSymbol, line, column, msg, e):
        ...
        stack.reverse()
        token = recognizer.getInputStream().tokenSource.text
        text = recognizer.getInputStream().tokenSource.inputStream.strdata
