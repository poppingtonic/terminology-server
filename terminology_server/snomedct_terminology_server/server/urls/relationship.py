...
relationship_urls = [
    ...
    url(r'relationships/$',
        cache_page(60 * 60 * 24 * 7)(views.ListRelationships.as_view()),
    ...
    url(r'relationships/qualifiers/(?P<concept_id>\d+)/$',
        views.ListAllowableQualifiers.as_view(),
        name='list-allowable-qualifier-relationships'),

    url(r'relationship/parents/(?P<concept_id>\d+)/$',
        cache_page(60 * 60 * 24 * 7)(views.ListDirectParents.as_view()),
        name='list-concept-parents'),

    url(r'relationship/children/(?P<concept_id>\d+)/$',
        cache_page(60 * 60 * 24 * 7)(views.ListDirectChildren.as_view()),
        name='list-concept-children'),

    url(r'relationship/ancestors/(?P<concept_id>\d+)/$',
        cache_page(60 * 60 * 24 * 7)(views.ListAncestors.as_view()),
        name='list-concept-ancestors'),

    url(r'relationship/descendants/(?P<concept_id>\d+)/$',
        cache_page(60 * 60 * 24 * 7)(views.ListDescendants.as_view()),
